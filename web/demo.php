...
<h2>Demo of the installation on a fresh Windows 2012 RE setup</h2>
...
<div id="captions">
  <div id="caption-9" style="display: none">
    First thing is to <a href=http://win-builds.org/1.3-beta1>download the bootstrap binaries</a>.
  </div>
  ...
  <div id="caption-101" style="display: none">
  ...
  <div id="caption-135" style="display: none">
  ...
  <div id="caption-245" style="display: none">
